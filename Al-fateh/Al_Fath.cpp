void Al_Fateh(){
    ...
    string DC = "Al_Fath was founded on 1958 (64 years ago).\n"
                "Al_Fath 's Home town is alHassa.\n"
   ...
   alfath.stadium = "Prince Abdullah bin Jalawi Sports City Stadium is a football stadium located in Al-Ahsa, Saudi Arabia. This stadium is currently used by all Al-Ahsa clubs, and the stadium has a capacity of 27 thousand spectators.” \n";
