void Al_Ettifaq(){
    ...
    alaitifaq.stadium = " Prince Mohammed bin Fahd Stadium It is a football stadium located in the city of Dammam in the Eastern Province of the Kingdom of Saudi Arabia It has a capacity of 36000 thousand spectators.” \n";
...
void CLUBRF6(string moving_value){
    ...
    while(flag)
    {
        if(moving_value == "Back" || moving_value == "back" || moving_value == "BACK"){
            ...
            system("cls");
            flag = false;
            Al_Ettifaq(); // to choose another player
        }
